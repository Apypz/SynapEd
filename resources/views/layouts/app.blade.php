            ...
            <div class="min-w-0 flex-1">
                <div class="flex items-center justify-between gap-1">
                    ...
                    <span class="px-2 py-0.5 text-[10px] font-bold rounded uppercase tracking-wider flex-shrink-0
                        @if((Auth::user()->role ?? '') === 'admin') bg-rose-500/20 text-rose-300 border border-rose-500/30
                        @elseif((Auth::user()->role ?? '') === 'educator') bg-amber-500/20 text-amber-300 border border-amber-500/30
