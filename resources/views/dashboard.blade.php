<x-app-layout>
            ...
            <div class="glass-card rounded-2xl p-5 border border-white/08 hover:border-blue-500/20 transition-all group">
                <div class="flex items-start gap-4 mb-5">
                    ...
                    <span class="px-2 py-1 rounded-full text-xs font-semibold flex-shrink-0"
                          style="background:rgb(214, 229, 247);color:blue;border:1px solid {{ $lm['border'] }};">{{ $c['level'] }}</span>
                </div>
                <div class="mb-4">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-slate-400 text-xs">Kemajuan</span>
                        <span class="text-xs font-semibold" style="color:blue;">{{ $e['progress'] }}%</span>
                    </div>
                    <div class="h-2 rounded-full bg-white/08 overflow-hidden">
                        <div class="h-full rounded-full" style="width:{{ $e['progress'] }}%;background:linear-gradient(135deg, #2563EB, #0b3d91);"></div>
                    </div>
                </div>
    ...
    <div>
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            @php $grads=['linear-gradient(135deg,#2563EB,#0b3d91)','linear-gradient(135deg,#2563EB,#0b3d91)','linear-gradient(135deg,#2563EB,#0b3d91)','linear-gradient(135deg,#2563EB,#0b3d91)']; @endphp
