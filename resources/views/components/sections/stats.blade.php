    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 mt-12 pt-12 border-t border-gray-200">
            ...
            <div class="flex flex-col items-center lg:items-start group">
                <div class="text-4xl font-bold text-[#0056D2] mb-1 group-hover:scale-110 transition-transform">
                    {{ $stat['value'] }}
                </div>
                <div class="text-sm font-bold text-gray-800 uppercase tracking-widest">
                    {{ $stat['label'] }}
                </div>
